...
// for(let i=1;i<=10;i++){
//     document.write(`<h1>Hello Okten!`);
// }

// ----------------#TYj7ncx-------------

// for(let i=1;i<=10;i++){
//     document.write(`<h1>Hello Okten!${i}`);
// }
...
// let listOfItems = ['html', 'css', 'js', 'mysql', 'mongodb', 'react', 'angular', 'nodejs'];
//
// for (let index of listOfItems) {
...
//     if (user.status === true) {
//         document.write(`<h1>${user.name} - ${user.status}</h1>`);
//     }
// }
// for (const user of users) {
